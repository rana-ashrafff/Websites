// Shared site behaviour: mobile nav toggle + hero carousel + FAQ accordion + certificates demo
// Nav dropdowns (Competitions / Participants) open on hover via CSS on desktop;
// on mobile (no hover) they expand in place when their button is tapped.
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Mobile dropdown expand (Competitions / Participants / More)
